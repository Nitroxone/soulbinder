...
const Data = Object.freeze({
    ...
    TriggerType: {
        ...
        ON_DEAL_POISON_TICK: 'ON_DEAL_POISON_TICK',
        ON_RECV_POISON_TICK: 'ON_RECV_POISON_TICK',
        ON_DEAL_BLEEDING: 'ON_DEAL_BLEEDING',
        ON_RECV_BLEEDING: 'ON_RECV_BLEEDING',
        ON_DEAL_BLEEDING_TICK: 'ON_DEAL_BLEEDING_TICK',
        ON_RECV_BLEEDING_TICK: 'ON_RECV_BLEEDING_TICK',
        ON_DEAL_MOVE: 'ON_DEAL_MOVE',
        ON_RECV_MOVE: 'ON_MOVE',
        ON_DEAL_DEATHBLOW: 'ON_DEAL_DEATHBLOW',
        ON_RECV_DEATHBLOW: 'ON_RECV_DEATHBLOW',
        ON_DEAL_EFFECTS: 'ON_DEAL_EFFECTS',
        ON_RECV_EFFECTS: 'ON_RECV_EFFECTS',

        ON_RECV_WITHERING: 'ON_RECV_WITHERING',
        ON_DEAL_WITHERING: 'ON_DEAL_WITHERING',
        ON_RECV_SHARPNESS: 'ON_RECV_SHARPNESS',
        ON_DEAL_SHARPNESS: 'ON_DEAL_SHARPNESS',
        ...
        ON_GUARDED_BEGIN: 'ON_GUARDED_BEGIN',
        ON_GUARDED_END: 'ON_GUARDED_END',

...
//     }
//     // checks if the current dungeon instance has an event history. Allows the event class to choose between an entrance or regular event
//     isHistoryEmpty() {
//         return this.history.length === 0;
//     }
//     // store the instance of the event generated by the CreateEvent() function 
//     generateEvent() {
